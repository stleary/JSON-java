 ...
 * notations for name/value pairs. See also: <a
...
public class Cookie {
     ...
     *     have at least one '=' character and the 'name' portion of the cookie must not be blank.
     */
     ...
     * attributes, so ensure your JSONObject is using only known attributes. See also: <a
     * href="https://tools.ietf.org/html/rfc6265">https://tools.ietf.org/html/rfc6265</a>
     *
