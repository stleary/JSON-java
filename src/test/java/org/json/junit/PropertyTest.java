...
public class PropertyTest {
    ...
    /** JSONObject from null properties object should result in an empty JSONObject. */
    @Test
    ...
    /** JSONObject from empty properties object should result in an empty JSONObject. */
    @Test
    ...
    public void shouldHandleProperties() {
        ...
        assertTrue(
                "jsonObject should contain Illinois property",
                "Springfield".equals(jsonObject.get("Illinois")));
        assertTrue(
                "jsonObject should contain Missouri property",
                "Jefferson City".equals(jsonObject.get("Missouri")));
        assertTrue(
                "jsonObject should contain Washington property",
                "Olympia".equals(jsonObject.get("Washington")));
        assertTrue(
                "jsonObject should contain California property",
                "Sacramento".equals(jsonObject.get("California")));
        assertTrue(
                "jsonObject should contain Indiana property",
                "Indianapolis".equals(jsonObject.get("Indiana")));
    }

    /** Null JSONObject toProperties() should result in an empty Properties object. */
    @Test
    ...
    /** Properties should convert to JSONObject, and back to Properties without changing. */
    @Test
