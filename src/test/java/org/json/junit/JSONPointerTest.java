...
public class JSONPointerTest {
    ...
    private static final String EXPECTED_COMPLETE_DOCUMENT =
            "{\"\":0,\" \":7,\"g|h\":4,\"c%d\":2,\"k\\\"l\":6,\"a/b\":1,\"i\\\\j\":5,"
    ...
    public void queryByEmptyKeySubObject() {
        JSONObject json =
                new JSONObject(
                        "{\"\":\"empty key of an object with an empty key\",\"subKey\":\"Some"
                                + " other value\"}");
    ...
    public void queryFromJSONObject() {
        ...
        try {
            ...
            assertTrue(
                    "Expected bad key/value exception",
    ...
    /**
     * When creating a jsonObject we need to parse escaped characters "\\\\" --> it's the string
     * representation of "\\", so when query'ing via the JSONPointer we DON'T escape them
     */
    @Test
