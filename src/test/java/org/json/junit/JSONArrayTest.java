...
public class JSONArrayTest {
    ...
    public void verifySimilar() {
        ...
        JSONArray obj1 = new JSONArray().put("abc").put(string1).put(2);

        JSONArray obj2 = new JSONArray().put("abc").put(string1).put(3);

        JSONArray obj3 = new JSONArray().put("abc").put(new String(string1)).put(2);

        JSONArray obj4 = new JSONArray().put("abc").put(2.0).put(new String(string1));

        JSONArray obj5 = new JSONArray().put("abc").put(2.0).put(new String(string2));
    ...
    /** Attempt to create a JSONArray with a null string. Expects a NullPointerException. */
    ...
    /** Attempt to create a JSONArray with an empty string. Expects a JSONException. */
    @Test
    public void emptStr() {
        String str = "";
        try {
    ...
    /** Attempt to create a JSONArray with an unclosed array. Expects an exception */
    @Test
    ...
    /**
     * Attempt to create a JSONArray with a string as object that is not a JSON array doc. Expects a
     * JSONException.
     */
    @Test
    ...
    public void verifyPutCollection() {
        ...
        assertTrue(
                "The RAW Collection should give me the same as the Typed Collection",
                expected.similar(jaInt));
        Util.checkJSONArraysMaps(new ArrayList<JSONArray>(Arrays.asList(jaRaw, jaObj, jaInt)));
    }
    ...
    public void verifyPutMap() {
        ...
        Util.checkJSONArraysMaps(
                new ArrayList<JSONArray>(
                        Arrays.asList(expected, jaRaw, jaStrObj, jaStrInt, jaObjObj)));
    }

    /**
     * Create a JSONArray doc with a variety of different elements. Confirm that the values can be
     * accessed via the get[type]() API methods
     */
    ...
    /**
     * Create a JSONArray doc with a variety of different elements. Confirm that attempting to get
     * the wrong types via the get[type]() API methods result in JSONExceptions
     */
    @Test
    public void failedGetArrayValues() {
        ...
        try {
            ...
            assertEquals(
                    "Expected an exception message",
                    "JSONArray[4] is not a boolean (class java.lang.String : hello).",
                    e.getMessage());
        }
        try {
            jsonArray.get(-1);
            ...
            assertEquals(
                    "Expected an exception message", "JSONArray[-1] not found.", e.getMessage());
        }
        try {
            ...
            assertEquals(
                    "Expected an exception message",
                    "JSONArray[4] is not a double (class java.lang.String : hello).",
                    e.getMessage());
        }
        try {
            jsonArray.getInt(4);
            ...
            assertEquals(
                    "Expected an exception message",
                    "JSONArray[4] is not a int (class java.lang.String : hello).",
                    e.getMessage());
        }
        try {
            ...
            assertEquals(
                    "Expected an exception message",
                    "JSONArray[4] is not a JSONArray (class java.lang.String : hello).",
                    e.getMessage());
        }
        try {
            ...
            assertEquals(
                    "Expected an exception message",
                    "JSONArray[4] is not a JSONObject (class java.lang.String : hello).",
                    e.getMessage());
        }
        try {
            jsonArray.getLong(4);
            ...
            assertEquals(
                    "Expected an exception message",
                    "JSONArray[4] is not a long (class java.lang.String : hello).",
                    e.getMessage());
        }
        try {
            ...
            assertEquals(
                    "Expected an exception message",
                    "JSONArray[5] is not a String (class java.math.BigDecimal : 0.002345).",
                    e.getMessage());
        }
        Util.checkJSONArrayMaps(jsonArray);
    }
    ...
    /**
     * Exercise JSONArray.join() by converting a JSONArray into a comma-separated string. Since this
     * is very nearly a JSON document, array braces are added to the beginning and end prior to
     * validation.
     */
    @Test
    public void join() {
        ...
        assertTrue(
                "expected 13 items in top level object",
                ((List<?>) (JsonPath.read(doc, "$"))).size() == 13);
        ...
        assertTrue(
                "expected 4 items in [10]",
                ((Map<?, ?>) (JsonPath.read(doc, "$[10]"))).size() == 4);
    ...
    public void length() {
        ...
        JSONArray jsonArray = new JSONArray(this.arrayStr);
        assertTrue(
                "expected JSONArray length 13. instead found " + jsonArray.length(),
                jsonArray.length() == 13);
        JSONArray nestedJsonArray = jsonArray.getJSONArray(9);
        assertTrue("expected JSONArray length 1", nestedJsonArray.length() == 1);
        Util.checkJSONArraysMaps(
                new ArrayList<JSONArray>(Arrays.asList(jsonArray, nestedJsonArray)));
    }

    /**
     * Create a JSONArray doc with a variety of different elements. Confirm that the values can be
     * accessed via the opt[type](index) and opt[type](index, default) API methods.
     */
    @SuppressWarnings("boxing")
    @Test
    public void opt() {
        ...
        assertTrue(
                "Array opt double default implicit", new Double(jsonArray.optDouble(99)).isNaN());
    ...
    /**
     * Exercise the JSONArray.put(value) method with various parameters and confirm the resulting
     * JSONArray.
     */
    @SuppressWarnings("boxing")
    @Test
    public void put() {
        ...
        String jsonArrayStr = "[" + "hello," + "world" + "]";
        // 2
        ...
        String jsonObjectStr =
                "{" + "\"key10\":\"val10\"," + "\"key20\":\"val20\"," + "\"key30\":\"val30\"" + "}";
        ...
        assertTrue(
                "expected 10 top level items", ((List<?>) (JsonPath.read(doc, "$"))).size() == 10);
        assertTrue("expected true", Boolean.TRUE.equals(jsonArray.query("/0")));
        assertTrue("expected false", Boolean.FALSE.equals(jsonArray.query("/1")));
        ...
        assertTrue(
                "expected 3 items in [7]", ((Map<?, ?>) (JsonPath.read(doc, "$[7]"))).size() == 3);
        ...
        assertTrue(
                "expected 1 item in [8]", ((Map<?, ?>) (JsonPath.read(doc, "$[8]"))).size() == 1);
    ...
    /**
     * Exercise the JSONArray.put(index, value) method with various parameters and confirm the
     * resulting JSONArray.
     */
    @SuppressWarnings("boxing")
    @Test
    public void putIndex() {
        ...
        Object doc =
                Configuration.defaultConfiguration().jsonProvider().parse(jsonArray.toString());
        assertTrue(
                "expected 11 top level items", ((List<?>) (JsonPath.read(doc, "$"))).size() == 11);
        assertTrue("expected true", Boolean.TRUE.equals(jsonArray.query("/0")));
        assertTrue("expected false", Boolean.FALSE.equals(jsonArray.query("/1")));
        assertTrue("expected 2 items in [2]", ((List<?>) (JsonPath.read(doc, "$[2]"))).size() == 2);
        assertTrue("expected hello", "hello".equals(jsonArray.query("/2/0")));
        ...
        assertTrue(
                "expected 3 items in [8]", ((Map<?, ?>) (JsonPath.read(doc, "$[8]"))).size() == 3);
        ...
        assertTrue("expected 2", Integer.valueOf(2).equals(jsonArray.query("/9/1")));
        assertTrue(
                "expected 1 item in [10]", ((Map<?, ?>) (JsonPath.read(doc, "$[10]"))).size() == 1);
        assertTrue("expected v1", "v1".equals(jsonArray.query("/10/k1")));
        Util.checkJSONObjectMaps(jsonObject);
        Util.checkJSONArrayMaps(jsonArray);
    }

    /** Exercise the JSONArray.remove(index) method and confirm the resulting JSONArray. */
    @Test
    public void remove() {
        String arrayStr1 = "[" + "1" + "]";
    ...
    /**
     * Exercise the JSONArray.similar() method with various parameters and confirm the results when
     * not similar.
     */
    @Test
    public void notSimilar() {
        ...
        Util.checkJSONArraysMaps(
                new ArrayList<JSONArray>(Arrays.asList(jsonArray, otherJsonArray)));
        Util.checkJSONObjectsMaps(
                new ArrayList<JSONObject>(Arrays.asList(jsonObject, otherJsonObject)));
    }
    ...
    public void toJSONObject() {
        ...
        Util.checkJSONArraysMaps(new ArrayList<JSONArray>(Arrays.asList(names, jsonArray)));
    }
    ...
    public void iteratorTest() {
        ...
        assertTrue(
                "Array value string long", new Long(-1).equals(Long.parseLong((String) it.next())));
    ...
    */
    ...
    public void toList() {
        ...
        assertTrue(
                "val3 list val 1 list element 1 should be value1",
                val3Val1List.get(0).equals("value1"));
        assertTrue(
                "val3 list val 1 list element 2 should be 2.1",
                val3Val1List.get(1).equals(new BigDecimal("2.1")));
    ...
    /**
     * Create a JSONArray with specified initial capacity. Expects an exception if the initial
     * capacity is specified as a negative integer
     */
    @Test
    ...
    public void testJSONArrayConstructor() {
        ...
        Util.checkJSONArraysMaps(new ArrayList<JSONArray>(Arrays.asList(a1, a2)));
    }
    ...
    public void jsonArrayClearMethodTest() {
        ...
        assertTrue(
                "expected jsonArray.length() == 0",
                jsonArray.length() == 0); // Check if its length is 0
    ...
    public void testIssue682SimilarityOfJSONString() {
        JSONArray ja1 = new JSONArray().put(new MyJsonString()).put(2);
        JSONArray ja2 = new JSONArray().put(new MyJsonString()).put(2);
