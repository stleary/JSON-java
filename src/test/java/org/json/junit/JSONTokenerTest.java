...
public class JSONTokenerTest {
    ...
    /**
     * Verifies that JSONTokener can read a stream that contains a value. After the reading is done,
     * check that the stream is left in the correct state by reading the characters after. All valid
     * cases should reach end of stream.
     *
     * @param testStr
     * @return
     * @throws Exception
    ...
    public void testNextBackComboWithNewLines() {
        ...
        tokener.skipTo('\n');
        assertEquals(
                "skipTo() improperly modifying indexes",
                " at 7 [character 8 line 1]",
                tokener.toString());
        assertEquals('\n', tokener.next());
