...
/**
 * Tests for JSONString implementations, and the difference between {@link JSONObject#valueToString}
 * and {@link JSONObject#writeValue}.
 */
public class JSONStringTest {

    /**
     * This tests the JSONObject.writeValue() method. We can't test directly due to it being a
     * package-protected method. Instead, we can call JSONArray.write(), which delegates the writing
     * of each entry to writeValue().
     */
    @Test
    ...
    /**
     * This tests the JSONObject.valueToString() method. These should be identical to the values
     * above, except for the enclosing [ and ].
     */
    ...
    /**
     * Test what happens when toJSONString() returns a well-formed JSON value. This is the usual
     * case.
     */
    @Test
    public void testJSONStringValue() throws Exception {
        ...
        try {
            String output = jsonArray.write(writer).toString();
            assertTrue(
                    "String values should be equal", "[\"the JSON string value\"]".equals(output));
    ...
    /**
     * Test what happens when toJSONString() returns null. In one case, use the object's toString()
     * method. In the other, throw a JSONException.
     */
    @Test
    ...
    /**
     * Test what happens when toJSONString() returns an exception. In both cases, a JSONException is
     * thrown, with the cause and message set from the original exception.
     */
    @Test
    public void testJSONStringExceptionValue() {
        ...
        try {
            ...
            assertTrue(
                    "Exception message does not match",
                    "the exception value".equals(e.getMessage()));
        } catch (Exception e) {
            fail("Expected JSONException");
        }
    }
    ...
    /**
     * Test what happens when a Java object's toString() returns a String value. This is the usual
     * case.
     */
    @Test
    public void testStringValue() throws Exception {
        ...
        try {
            String output = jsonArray.write(writer).toString();
            assertTrue(
                    "String values should be equal",
                    "[\"the toString value for StringValue\"]".equals(output));
    ...
    /** Test what happens when a Java object's toString() returns null. Defaults to empty string. */
    @Test
