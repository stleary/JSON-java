...
public class XMLTest {
    ...
    public void testJsonToXmlEscape() {
        ...
        assertTrue(
                "Escaping \u0085 failed. Entity not found in XML output.", xml.contains("&#x85;"));
    ...
    public void contentOperations() {
        ...
        assertTrue(
                ...
                jsonObject.get("content") instanceof JSONArray);
    ...
    /**
     * test passes when xsi:nil="true" converting to null (JSON specification-like nil conversion
     * enabled)
     */
    @Test
    ...
    /**
     * test passes when xsi:nil="true" not converting to null (JSON specification-like nil
     * conversion disabled)
     */
    @Test
    ...
    public void testIssue537CaseSensitiveHexEscapeFullFile() {
        try {
            ...
            try {
                ...
                try {
                    jsonStream =
                            XMLTest.class.getClassLoader().getResourceAsStream("Issue537.json");
    ...
    public void testToJsonWithTypeWhenTypeConversionDisabled() {
        ...
        String expectedJsonString =
                "{\"root\":{\"id\":{\"xsi:type\":\"string\",\"content\":1234}}}";
    ...
    public void testToJsonWithTypeWhenTypeConversionEnabled() {
        String originalXml =
                "<root><id1 xsi:type=\"string\">1234</id1>"
        ...
        xsiTypeMap.put(
                "string",
                new XMLXsiTypeConverter<String>() {
                    @Override
        ...
        xsiTypeMap.put(
                "integer",
                new XMLXsiTypeConverter<Integer>() {
                    @Override
        ...
        JSONObject actualJson =
                XML.toJSONObject(
                        originalXml, new XMLParserConfiguration().withXsiTypeMap(xsiTypeMap));
        Util.compareActualVsExpectedJsonObjects(actualJson, expectedJson);
    }
    ...
    public void testToJsonWithXSITypeWhenTypeConversionEnabled() {
        String originalXml =
                "<root><asString xsi:type=\"string\">12345</asString><asInt "
    ...
    public void testXSITypeMapNotModifiable() {
        ...
        assertEquals(
                "Config Conversion Map size is expected to be 0", 0, config.getXsiTypeMap().size());

        try {
            config.getXsiTypeMap()
                    .put(
                            "boolean",
                            new XMLXsiTypeConverter<Boolean>() {
                                @Override
    ...
    public void testIndentComplicatedJsonObjectWithArrayAndWithConfig() {
        try {
            ...
            try {
                ...
                String actualString =
                        XML.toString(object, null, XMLParserConfiguration.KEEP_STRINGS, 2);
                InputStream xmlStream = null;
                try {
    ...
    public void testMaxNestingDepthWithValidFittingXML() {
        ...
        try {
            ...
            e.printStackTrace();
            fail(
                    "XML document should be parsed as its maximum depth fits the maxNestingDepth "
