...
//    }
    ...
    public void testToJSONArrayMaxNestingDepthOf42IsRespected() {
        ...
        try {
            JSONML.toJSONArray(wayTooLongMalformedXML, JSONML.JSONML_PARSER_CONFIGURATION.withMaxNestingDepth(maxNestingDepth));
    ...
    public void testToJSONArrayMaxNestingDepthIsRespectedWithValidXML() {
        ...
        try {
            JSONML.toJSONArray(perfectlyFineXML, JSONML.JSONML_PARSER_CONFIGURATION.withMaxNestingDepth(maxNestingDepth));
    ...
    public void testToJSONObjectMaxDefaultNestingDepthIsRespected() {
        ...
        try {
            JSONML.toJSONObject(wayTooLongMalformedXML, JSONML.JSONML_PARSER_CONFIGURATION);
    ...
    public void testToJSONObjectUnlimitedNestingDepthIsPossible() {
        ...
        try {
            JSONML.toJSONObject(deeperThanDefaultMax, JSONML.JSONML_PARSER_CONFIGURATION
    ...
    public void testToJSONObjectMaxNestingDepthOf42IsRespected() {
        ...
        try {
            JSONML.toJSONObject(wayTooLongMalformedXML, JSONML.JSONML_PARSER_CONFIGURATION.withMaxNestingDepth(maxNestingDepth));
    ...
    public void testToJSONObjectMaxNestingDepthIsRespectedWithValidXML() {
        ...
        try {
            JSONML.toJSONObject(perfectlyFineXML, JSONML.JSONML_PARSER_CONFIGURATION.withMaxNestingDepth(maxNestingDepth));
