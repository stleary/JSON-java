...
public class XMLConfigurationTest {
    ...
    /** Invalid XML string ('!' char and no closing tag brace) Expects a JSONException */
    @Test
    ...
    public void shouldHandleNullJSONXML() {
        ...
        String actualXml = XML.toString(jsonObject, null, XMLParserConfiguration.KEEP_STRINGS);
    ...
    public void shouldHandleEmptyJSONXML() {
        ...
        String xmlStr = XML.toString(jsonObject, null, XMLParserConfiguration.KEEP_STRINGS);
    ...
    public void shouldHandleCommentsInXML() {
        ...
        String expectedStr =
                "{\"addresses\":{\"address\":{\"street\":\"Baker "
    ...
    public void shouldHandleToString() {
        ...
        JSONObject jsonObject = XML.toJSONObject(xmlStr, XMLParserConfiguration.KEEP_STRINGS);
        String xmlToStr = XML.toString(jsonObject, null, XMLParserConfiguration.KEEP_STRINGS);
        JSONObject finalJsonObject =
                XML.toJSONObject(xmlToStr, XMLParserConfiguration.KEEP_STRINGS);
        JSONObject expectedJsonObject = new JSONObject(expectedStr);
        Util.compareActualVsExpectedJsonObjects(jsonObject, expectedJsonObject);
    ...
    /**
     * Converting a JSON doc containing '>' content to JSONObject, then XML.toString() should result
     * in valid XML.
     */
    @Test
    public void shouldHandleContentNoArraytoString() {
        ...
        assertTrue(
                "Should handle expectedFinal: [" + expectedStr + "] final: [" + finalStr + "]",
                expectedFinalStr.equals(finalStr));
    }

    /**
     * Converting a JSON doc containing a 'content' array to JSONObject, then XML.toString() should
     * result in valid XML. TODO: This is probably an error in how the 'content' keyword is used.
     */
    @Test
    ...
    /**
     * Converting a JSON doc containing a named array to JSONObject, then XML.toString() should
     * result in valid XML.
     */
    @Test
    public void shouldHandleArraytoString() {
        ...
        JSONObject expectedJsonObject = new JSONObject(expectedStr);
        String finalStr =
                XML.toString(expectedJsonObject, null, XMLParserConfiguration.KEEP_STRINGS);
    ...
    public void shouldHandleEmptyArray() {
        ...
        String output1 = XML.toString(jo1, "jo", XMLParserConfiguration.KEEP_STRINGS);
        assertEquals("Expected an empty root tag", expected, output1);
        String output2 = XML.toString(jo2, "jo", XMLParserConfiguration.KEEP_STRINGS);
    ...
    /**
     * Tests that the XML output for arrays is consistent when arrays are not empty and contain
     * internal arrays.
     */
    @Test
    public void shouldHandleMultiArray() {
        ...
        jo2.put(
                ...
                new JSONArray(
                        new Object[] {
                            "One", new JSONArray(new String[] {"Two", "Three"}), "Four"
                        }));

        final String expected =
                "<jo><arr>One</arr><arr><array>Two</array><array>Three</array></arr><arr>Four</arr></jo>";
        String output1 = XML.toString(jo1, "jo", XMLParserConfiguration.KEEP_STRINGS);
        assertEquals("Expected a matching array", expected, output1);
        String output2 = XML.toString(jo2, "jo", XMLParserConfiguration.KEEP_STRINGS);
        assertEquals("Expected a matching array", expected, output2);
    ...
    /**
     * Converting a JSON doc containing a named array of nested arrays to JSONObject, then
    ...
    public void shouldHandleNestedArraytoString() {
        ...
        String finalStr = XML.toString(jsonObject, null, XMLParserConfiguration.ORIGINAL);
        ...
        JSONObject expectedJsonObject =
                XML.toJSONObject(expectedStr, XMLParserConfiguration.ORIGINAL);
        Util.compareActualVsExpectedJsonObjects(finalJsonObject, expectedJsonObject);
    }

    /**
     * Possible bug: Illegal node-names must be converted to legal XML-node-names. The given example
     * shows 2 nodes which are valid for JSON, but not for XML. Therefore illegal arguments should
     * be converted to e.g. an underscore (_).
     */
    @Test
    public void shouldHandleIllegalJSONNodeNames() {
        ...
        String result = XML.toString(inputJSON, null, XMLParserConfiguration.KEEP_STRINGS);
         ...
         */
        String expected =
                "<123IllegalNode>someValue1</123IllegalNode><Illegal@node>someValue2</Illegal@node>";

        assertEquals("Length", expected.length(), result.length());
        assertTrue(
                "123IllegalNode", result.contains("<123IllegalNode>someValue1</123IllegalNode>"));
    ...
    public void shouldHandleNullNodeValue() {
        ...
        /** This is the current behavior. JSONObject.NULL is emitted as the string, "null". */
        String actualXML = "<nullValue>null</nullValue>";
        String resultXML = XML.toString(inputJSON, null, XMLParserConfiguration.KEEP_STRINGS);
    ...
    public void contentOperations() {
        ...
        assertTrue(
                "1. content found",
                "if (a < b && a > 0) then return".equals(jsonObject.get("content")));

        // multiple consecutive standalone cdatas are accumulated into an array
        xmlStr =
                "<tag1></tag1><![CDATA[if (a < b && a > 0) then return]]><tag2></tag2><![CDATA[here is another cdata]]>";
        jsonObject =
                XML.toJSONObject(
                        xmlStr,
        ...
        assertTrue(
                "2. content array entry 0",
                "if (a < b && a > 0) then return".equals(jsonArray.get(0)));
    ...
    public void testToJSONArray_jsonOutput() {
        ...
        final JSONObject actualJsonOutput =
                XML.toJSONObject(originalXml, new XMLParserConfiguration().withKeepStrings(false));
    ...
    public void testToJSONArray_reversibility() {
        ...
        final String revertedXml =
                XML.toString(XML.toJSONObject(originalXml, config), null, config);
    ...
    public void testToJsonXML() {
        ...
        final JSONObject json =
                XML.toJSONObject(originalXml, new XMLParserConfiguration().withKeepStrings(true));
        ...
        final String expectedReverseXml =
                "<root><item><id>01</id></item><id>01</id><id>1</id><id>00</id><id>0</id><title>True</title></root>";

        assertEquals("length", expectedReverseXml.length(), reverseXml.length());
        assertTrue(
                "array contents",
                reverseXml.contains("<id>01</id><id>1</id><id>00</id><id>0</id>"));
    ...
    public void testUnescape() {
        assertEquals(
                "{\"xml\":\"Can cope <;\"}",
                XML.toJSONObject("<xml>Can cope &lt;; </xml>", XMLParserConfiguration.KEEP_STRINGS)
                        .toString());
        ...
        assertEquals(
                "{\"xml\":\"Can cope & ;\"}",
                XML.toJSONObject(
                                "<xml>Can cope &amp; ; </xml>", XMLParserConfiguration.KEEP_STRINGS)
                        .toString());
        assertEquals("Can cope & ; ", XML.unescape("Can cope &amp; ; "));
        ...
        assertEquals(
                "{\"xml\":\"Can cope 4;\"}",
                XML.toJSONObject(
                                "<xml>Can cope &#x34;; </xml>", XMLParserConfiguration.KEEP_STRINGS)
                        .toString());
    ...
    public void testConfig() {
        /**
         * 1st param is whether to keep the raw string, or call XML.stringToValue(), which may
         * convert the token to boolean, null, or number. 2nd param is what JSON name to use for
         * strings that are evaluated as xml content data in complex objects, e.g. <parent>
         * <child>value</child> content data </tag>
         */
        String xmlStr =
                "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
                        + "<addresses xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\""
        ...
        XMLParserConfiguration config =
                new XMLParserConfiguration().withKeepStrings(true).withcDataTagName("altContent");
        JSONObject jsonObject = XML.toJSONObject(xmlStr, config);
        // num is parsed as a string
        assertEquals(
                jsonObject.getJSONObject("addresses").getJSONObject("address").getString("num"),
                "1");
        ...
        // keepstrings only
        jsonObject = XML.toJSONObject(xmlStr, XMLParserConfiguration.KEEP_STRINGS);
        // num is parsed as a string
        assertEquals(
                jsonObject.getJSONObject("addresses").getJSONObject("address").getString("num"),
                "1");
        ...
        assertEquals(
                jsonObject.getJSONObject("addresses").getJSONObject("address").getInt("num"), 1);
        // complex content is collected in an 'altContent' array
        jsonArray =
                jsonObject
                        .getJSONObject("addresses")
    ...
    public void testSimpleForceList() {
        ...
        XMLParserConfiguration config = new XMLParserConfiguration().withForceList(forceList);
        JSONObject jsonObject = XML.toJSONObject(xmlStr, config);
    ...
    public void testMaxNestingDepthIsSet() {
        ...
        assertEquals(
                xmlParserConfiguration.getMaxNestingDepth(),
    ...
    /**
     * Convenience method, given an input string and expected result, convert to JSONObject and
     * compare actual to expected result.
     *
     * @param xmlStr the string to parse
     * @param expectedStr the expected JSON string
     * @param config provides more flexible XML parsing flexible XML parsing.
     */
    private void compareStringToJSONObject(
            String xmlStr, String expectedStr, XMLParserConfiguration config) {
        JSONObject expectedJsonObject = new JSONObject(expectedStr);
        JSONObject jsonObject = XML.toJSONObject(xmlStr, config);
        Util.compareActualVsExpectedJsonObjects(jsonObject, expectedJsonObject);
    }
    ...
    /**
     * Convenience method, given an input string and expected result, convert to JSONObject via
     * reader and compare actual to expected result.
     *
     * @param xmlStr the string to parse
     * @param expectedStr the expected JSON string
     * @param config provides more flexible XML parsing
     */
    private void compareReaderToJSONObject(
            String xmlStr, String expectedStr, XMLParserConfiguration config) {
        /*
    ...
    /**
     * Convenience method, given an input string and expected result, convert to JSONObject via file
     * and compare actual to expected result.
     *
     * @param xmlStr the string to parse
     * @param expectedStr the expected JSON string
     * @throws IOException
